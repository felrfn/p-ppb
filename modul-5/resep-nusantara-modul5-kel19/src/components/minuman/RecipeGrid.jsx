...
export default function RecipeGrid({ recipes, onRecipeClick }) {
  ...
  const [loadedImages, setLoadedImages] = useState(new Set()); // track gambar yang udah dimuat
  ...
  return (
    <section>
      ...
      <p className="text-center text-slate-500 max-w-2xl mx-auto mb-8">
        Temukan minuman segar, hangat, dan kekinian. Mulai dari kopi, jus,
        hingga minuman tradisional yang menggugah selera.
      </p>
